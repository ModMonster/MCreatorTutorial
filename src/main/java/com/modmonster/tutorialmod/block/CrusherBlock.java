...
import com.modmonster.tutorialmod.gui.CrusherGUIGui;
import com.modmonster.tutorialmod.TutorialmodModElements;

@TutorialmodModElements.ModElement.Tag
public class CrusherBlock extends TutorialmodModElements.ModElement {
	@ObjectHolder("tutorialmod:crusher")
	public static final Block block = null;
	@ObjectHolder("tutorialmod:crusher")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public CrusherBlock(TutorialmodModElements instance) {
		super(instance, 23);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(6f, 30f).setLightLevel(s -> 0).harvestLevel(1)
